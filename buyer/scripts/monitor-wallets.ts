...
const OPERATOR_SOURCES: OperatorSource[] = [
  ...
  {
    label: "supplier-openclaw@inference-proxy",
    host: "inference-proxy",
    envPath: "/root/agents-marketplace/supplier/.env.openclaw",
    keyVar: "SUPPLIER_PRIV_KEY_HEX",
    role: "supplier",
  },
  {
    label: "supplier-qwen38-local@inference-proxy",
    host: "inference-proxy",
    envPath: "/root/agents-marketplace/supplier/.env.qwen38-local",
    keyVar: "SUPPLIER_PRIV_KEY_HEX",
    role: "supplier",
  },
  {
    label: "supplier-qwen38-local-oneshot@inference-proxy",
    host: "inference-proxy",
    envPath: "/root/agents-marketplace/supplier/.env.qwen38-local-oneshot",
    keyVar: "SUPPLIER_PRIV_KEY_HEX",
    role: "supplier",
  },
  {
