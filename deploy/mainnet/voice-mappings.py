...
# /app/config/voice_to_speaker.yaml inside the marketplace-mainnet-tts-piper container.
#
# Why this exists:
...
#
# Run via:
#   docker cp voice-mappings.py marketplace-mainnet-tts-piper:/tmp/voice-mappings.py
#   docker exec marketplace-mainnet-tts-piper python3 /tmp/voice-mappings.py
